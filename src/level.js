  ...
  constructor(level, width, height) {
    ...
    if (level === 0) {
      ...
      this.enemies.push(
        ...
        //new Enemy(width / 2 - 250, -480, 180, true, 4, "./enemies.png"),
        //new Enemy(width / 2 - 280, -480, 180, true, 5, "./enemies.png")

        //new Enemy(width / 2 + 100, -480, 0, true, "./enemies.png"),
        //new Enemy(width / 2 + 130, -480, 0, true, "./enemies.png"),
        //new Enemy(width / 2 + 160, -480, 0, true, "./enemies.png"),
        //new Enemy(width / 2 + 190, -480, 0, true, "./enemies.png"),
        //new Enemy(width / 2 + 220, -480, 0, true, "./enemies.png"),
        //new Enemy(width / 2 + 250, -480, 0, true, "./enemies.png"),

        //new Enemy(width / 2 - 230, -230, 45, true, "./enemies.png"),
        //new Enemy(width / 2 - 200, -200, 45, true, "./enemies.png"),
        //new Enemy(width / 2 - 170, -170, 45, true, "./enemies.png"),
        //new Enemy(width / 2 - 140, -140, 45, true, "./enemies.png"),
        //new Enemy(width / 2 - 110, -110, 45, true, "./enemies.png"),
        //new Enemy(width / 2 - 80, -80, 45, true, "./enemies.png"),
        //new Enemy(width / 2 - 50, -50, 45, true, "./enemies.png"),
        //new Enemy(width / 2 + 198, -230, 135, true, "./enemies.png"),
        //new Enemy(width / 2 + 168, -200, 135, true, "./enemies.png"),
        //new Enemy(width / 2 + 138, -170, 135, true, "./enemies.png"),
        //new Enemy(width / 2 + 108, -140, 135, true, "./enemies.png"),
        //new Enemy(width / 2 + 78, -110, 135, true, "./enemies.png"),
        //new Enemy(width / 2 + 48, -80, 135, true, "./enemies.png"),
        //new Enemy(width / 2 + 18, -50, 135, true, "./enemies.png"),
