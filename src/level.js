  ...
  constructor(level, width, height) {
    ...
    if (level === 0) {
      ...
      this.enemies.push(
        ...
        new Enemy(width / 2 - 230, -230, 45, 1, true, "./enemies.png"),
        new Enemy(width / 2 - 200, -200, 45, 1, true, "./enemies.png"),
        new Enemy(width / 2 - 170, -170, 45, 1, true, "./enemies.png"),
        new Enemy(width / 2 - 140, -140, 45, 1, true, "./enemies.png"),
        new Enemy(width / 2 - 110, -110, 45, 1, true, "./enemies.png"),
        new Enemy(width / 2 - 80, -80, 45, 1, true, "./enemies.png"),
        new Enemy(width / 2 - 50, -50, 45, 1, true, "./enemies.png"),
        new Enemy(width / 2 + 198, -230, 135, 0, true, "./enemies.png"),
        new Enemy(width / 2 + 138, -170, 135, 0, true, "./enemies.png"),
        new Enemy(width / 2 + 108, -140, 135, 0, true, "./enemies.png"),
        new Enemy(width / 2 + 78, -110, 135, 0, true, "./enemies.png"),
        new Enemy(width / 2 + 48, -80, 135, 0, true, "./enemies.png"),
        new Enemy(width / 2 + 18, -50, 135, 0, true, "./enemies.png"),
