  ...
  constructor(level, width, height) {
    ...
    if (level === 1) {
      ...
      this.blocks.push(
        ...
        new Block(236, -400, 16, 16, 2, "./block.png"),
        new Block(252, -400, 16, 16, 1, "./block.png"),
        new Block(268, -400, 16, 16, 3, "./block.png"),
        new Block(284, -400, 16, 16, 1, "./block.png"),
        new Block(300, -400, 16, 16, 2, "./block.png"),
        new Block(316, -400, 16, 16, 1, "./block.png"),
        new Block(332, -400, 16, 16, 3, "./block.png"),
        new Block(348, -400, 16, 16, 1, "./block.png"),
        new Block(364, -400, 16, 16, 4, "./block.png"),
        new Block(380, -400, 16, 16, 2, "./block.png"),
        new Block(396, -400, 16, 16, 1, "./block.png"),
        new Block(412, -400, 16, 16, 2, "./block.png"),
        new Block(428, -400, 16, 16, 2, "./block.png"),
        new Block(444, -400, 16, 16, 1, "./block.png"),
        new Block(460, -400, 16, 16, 3, "./block.png"),
        new Block(476, -400, 16, 16, 1, "./block.png"),
        new Block(492, -400, 16, 16, 2, "./block.png"),
        new Block(508, -400, 16, 16, 1, "./block.png"),
        new Block(524, -400, 16, 16, 3, "./block.png"),
        new Block(540, -400, 16, 16, 1, "./block.png")
      );
      this.enemies.push(
