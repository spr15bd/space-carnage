  ...
  constructor(level, width, height) {
    ...
    if (level === 1) {
      ...
      this.enemies.push(
        ...
        new Enemy(360, 100, 270, 2, "./enemies.png"),
        new Enemy(420, 100, 270, 2, "./enemies.png"),
        new Enemy(480, 100, 270, 2, "./enemies.png"),
        new Enemy(540, 100, 270, 2, "./enemies.png"),

        new Enemy(180, 200, 270, 2, "./enemies.png"),
        new Enemy(240, 200, 270, 2, "./enemies.png"),
        new Enemy(300, 200, 270, 2, "./enemies.png"),
        new Enemy(360, 200, 270, 2, "./enemies.png"),
        new Enemy(420, 200, 270, 2, "./enemies.png"),
        new Enemy(480, 200, 270, 2, "./enemies.png"),
